...
Close a prototype-pollution primitive, unbias the random generator, and reconcile the guards.
...
*value* `undefined` for functions and symbols despite a `string` return type,
