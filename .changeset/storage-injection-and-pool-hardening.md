...
Close SQL injection and path traversal, and make the connection pool actually bound itself.
...
`update` and `count` concatenated the *keys* of the object they were given
