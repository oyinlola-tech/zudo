...
(function () {
  ...
  var SEARCH_INDEX = [
    ...
    { g: 'Learn', t: "Sequences (Programming thinking 13)", p: '/learn/logic-sequences', e: "Spot the pattern in a list of numbers, compute arithmetic and geometric sequences with loops and formulas, and see why compound interest and exponential growth surprise people." },
    { g: 'Learn', t: "Problem workshop: beginner (Programming thinking 14)", p: '/learn/solve-beginner', e: "Solve ten everyday problems, from even or odd to a tax calculator, by reasoning about inputs, outputs and edge cases first, then coding and testing each one." },
    { g: 'Learn', t: "Problem workshop: intermediate (Programming thinking 15)", p: '/learn/solve-intermediate', e: "Solve eight problems on lists of real data, from duplicate payments to stock levels, reasoning about edge cases and the amount of work first, then coding and testing." },
    { g: 'Learn', t: "Why doesn't this work? (Programming thinking 16)", p: '/learn/solve-broken', e: "Diagnose broken algorithms that run without errors but give wrong answers, using trace tables, predictions and boundary tests, then fix each root cause." },
    ...
    { g: 'Learn', t: "Narrowing (TypeScript 8)", p: '/learn/ts-narrowing', e: "Turn wide union and unknown types into precise ones with typeof, truthiness, equality, in, instanceof, discriminants, type guards and assertion functions, and learn where narrowing lies." },
    { g: 'Learn', t: "Type assertions (TypeScript 9)", p: '/learn/ts-assertions', e: "Learn what as, angle-bracket assertions, as unknown as and the non-null ! really do, see why none of them check or convert anything, and replace them with safer tools." },
    { g: 'Learn', t: "Enums and their alternatives (TypeScript 10)", p: '/learn/ts-enums', e: "Write numeric, string and const enums, read the exact JavaScript tsc emits for each, learn the pitfalls and erasableSyntaxOnly, and replace enums with unions and as const objects." },
    { g: 'Learn', t: "Tuples (TypeScript 11)", p: '/learn/ts-tuples', e: "Type fixed-shape arrays with tuples - optional, rest and named elements, readonly tuples, tuple inference and const type parameters - and return tuples from functions the way useState does." },
    { g: 'Learn', t: "Generics (TypeScript 12)", p: '/learn/ts-generics', e: "Write one function, interface or class that works for many types without losing type safety, set rules with constraints and keyof, give type parameters defaults, and build a Result type and a generic repository." },
    { g: 'Learn', t: "Advanced and utility types (TypeScript 13)", p: '/learn/ts-advanced', e: "Build new types from existing ones with keyof, typeof, indexed access, mapped, conditional and template literal types, and use the built-in utility types (Partial, Pick, Omit, Record, ReturnType, Awaited and more) to keep one source of truth." },
    { g: 'Learn', t: "Classes in TypeScript (TypeScript 14)", p: '/learn/ts-classes', e: "Declare typed class properties, use parameter properties and access modifiers, compare private with #private, write abstract classes and classes that implement interfaces, and wire classes together with constructor injection." },
    { g: 'Learn', t: "Modules in TypeScript (TypeScript 15)", p: '/learn/ts-modules', e: "Split a TypeScript project into files, import types with import type, see why verbatimModuleSyntax exists, write .js in import paths, and understand how NodeNext resolution, \"type\" - \"module\" and the \"exports\" field fit together." },
    { g: 'Learn', t: "TypeScript and JavaScript together (TypeScript 16)", p: '/learn/ts-runtime', e: "See exactly what TypeScript becomes when it runs, why types cannot check outside data, and how to close that gap by hand with type guards, assertion functions and a validator that returns a Result." },
