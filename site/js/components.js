...
(function () {
  ...
  var SEARCH_INDEX = [
    ...
    { g: 'Learn', t: "1. Set up your computer", p: '/learn/setup', e: "Install Node.js, run your first JavaScript file, and learn the two places you will run code in this course." },
    { g: 'Learn', t: "2. Values, variables and functions", p: '/learn/js-values', e: "Store values in variables, make decisions with if, repeat work with loops, and package logic into functions." },
    { g: 'Learn', t: "3. Objects, arrays and JSON", p: '/learn/js-data', e: "Group related values into objects, keep lists in arrays, transform them with map and filter, and turn them into JSON, the format every API speaks." },
    { g: 'Learn', t: "4. Asynchronous JavaScript", p: '/learn/js-async', e: "Learn why a backend waits without blocking, and how to write code that waits with promises, async and await." },
    { g: 'Learn', t: "5. Modules and errors", p: '/learn/js-modules', e: "Split a program into files with import and export, and handle things that go wrong with throw, try, catch and your own error classes." },
    { g: 'Learn', t: "6. From JavaScript to TypeScript", p: '/learn/ts-setup', e: "Install TypeScript, turn a JavaScript file into TypeScript, and watch the compiler catch a bug that JavaScript ran without complaint." },
