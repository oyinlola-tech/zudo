...
(function () {
  ...
  var SEARCH_INDEX = [
    ...
    { g: 'Learn', t: "Networking from JavaScript (JavaScript in the browser and on the server 13)", p: '/learn/browser-networking', e: "Connect a page to your Node.js Task API: the request lifecycle, JSON, the same-origin policy, CORS and preflight, HttpOnly session cookies and cancelling requests." },
    ...
    { g: 'Learn', t: "Classes in TypeScript (TypeScript 17)", p: '/learn/ts-classes', e: "Type class properties, use access modifiers and #private, write abstract classes and classes that implement interfaces, and wire them with constructor injection." },
