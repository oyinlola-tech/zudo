...
(function () {
  ...
  var SEARCH_INDEX = [
    ...
    { g: 'Learn', t: "The frequency counter pattern (Algorithms and data structures 12)", p: '/learn/pattern-frequency', e: "Replace nested loops with one counting pass: check anagram usernames, reconcile lists, find the first unmatched entry and the majority, in O(n)." },
    ...
    { g: 'Learn', t: "Iterables and iterators (Advanced JavaScript 4)", p: '/learn/js-iterators', e: "Learn the protocol behind for...of, spread and destructuring, then write your own iterables: a number range and an API paginator that fetches pages lazily." },
    { g: 'Learn', t: "Promises in depth (Advanced JavaScript 5)", p: '/learn/js-promises', e: "See exactly what a promise guarantees, how chains pass values and errors along, how thenables work, and how to turn a callback SDK into promises safely." },
