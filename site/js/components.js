...
(function () {
  ...
  var SEARCH_INDEX = [
    ...
    { g: 'Learn', t: "SQL with PostgreSQL (Backend engineering 4)", p: '/learn/sql-basics', e: "Run PostgreSQL with an installer or Docker, use psql, and write the SQL every backend needs: insert, select, update, delete, and placeholders that stop injection." },
