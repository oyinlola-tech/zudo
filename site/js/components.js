...
(function () {
  ...
  var SEARCH_INDEX = [
    ...
    { g: 'Learn', t: "Trees and binary search trees (Algorithms and data structures 5)", p: '/learn/dsa-trees', e: "Turn flat category rows into a tree, walk it four ways, then build, test and balance a binary search tree of orders, with the cost of every operation." },
    { g: 'Learn', t: "Heaps and priority queues (Algorithms and data structures 6)", p: '/learn/dsa-heaps', e: "Build a binary heap on a plain array, use it as a priority job queue, then sort with it, find the top-k products and merge sorted order lists." },
    { g: 'Learn', t: "Graphs and topological sort (Algorithms and data structures 7)", p: '/learn/dsa-graphs', e: "Model packages, roads between cities and followers as graphs, store them as adjacency lists, and compute a safe install order with topological sort." },
    { g: 'Learn', t: "Tries and autocomplete (Algorithms and data structures 8)", p: '/learn/dsa-tries', e: "Build a prefix tree for product search: autocomplete as the user types, count matches per prefix, delete safely, and weigh the memory it costs." },
    ...
    { g: 'Learn', t: "\"Special types: any, unknown, never and friends\" (TypeScript 9)", p: '/learn/ts-special-types', e: "Learn what any, unknown, never, void, object, {} and Object really mean, see how one any spreads through a codebase, and put unknown to work at your program's boundaries." },
    ...
    { g: 'Learn', t: "Advanced and utility types (TypeScript 15)", p: '/learn/ts-advanced', e: "Build new types from existing ones with keyof, typeof, indexed access, mapped, conditional and template literal types, and use the built-in utility types (Partial, Pick, Omit, Record, ReturnType, Awaited and more) to keep one source of truth." },
    { g: 'Learn', t: "Classes in TypeScript (TypeScript 16)", p: '/learn/ts-classes', e: "Declare typed class properties, use parameter properties and access modifiers, compare private with #private, write abstract classes and classes that implement interfaces, and wire classes together with constructor injection." },
    { g: 'Learn', t: "Modules in TypeScript (TypeScript 17)", p: '/learn/ts-modules', e: "Split a TypeScript project into files, import types with import type, see why verbatimModuleSyntax exists, write .js in import paths, and understand how NodeNext resolution, \"type\" - \"module\" and the \"exports\" field fit together." },
    { g: 'Learn', t: "TypeScript and JavaScript together (TypeScript 18)", p: '/learn/ts-runtime', e: "See exactly what TypeScript becomes when it runs, why types cannot check outside data, and how to close that gap by hand with type guards, assertion functions and a validator that returns a Result." },
    ...
    { g: 'Learn', t: "The application runtime and lifecycle (ZudoJS fundamentals 6)", p: '/learn/zudo-runtime', e: "Learn how the ZudoJS runtime starts the parts of your application in dependency order, rolls back when startup fails, reports readiness, and shuts everything down gracefully." },
    { g: 'Learn', t: "Dependency injection with @zudojs/container (ZudoJS fundamentals 7)", p: '/learn/zudo-container', e: "Let a container build and share your services. Learn tokens, class, factory and value providers, the singleton, scoped and transient lifetimes, circular dependency detection, disposal, and swapping real services for fakes in tests." },
    ...
    { g: 'Learn', t: "Configuration (ZudoJS fundamentals 10)", p: '/learn/zudo-config', e: "Keep settings out of the code with @zudojs/config. Layer defaults, a config file and environment variables by priority, validate the result with a schema, keep secrets out of logs, and make the Task API's generated configuration stricter in production than in development." },
    { g: 'Learn', t: "Schemas and validation in depth (ZudoJS fundamentals 11)", p: '/learn/zudo-validation', e: "Validate everything that crosses the Task API's boundary with @zudojs/schema. Read issues, coerce query strings, transform and refine values, block unknown fields, validate requests in routes and responses on the way out, and guard against hostile JSON with @zudojs/validation." },
    { g: 'Learn', t: "The ZudoJS error system (ZudoJS fundamentals 12)", p: '/learn/zudo-errors', e: "Handle failures the ZudoJS way. Tell expected errors from bugs, use and extend the error classes in @zudojs/errors, choose codes and categories, serialize errors safely for clients and fully for logs, and turn every error in the Task API into the right HTTP response." },
