...
(function () {
  ...
  var SEARCH_INDEX = [
    ...
    { g: 'Learn', t: "Types in depth (JavaScript fundamentals 4)", p: '/learn/js-types-deep', e: "Map every JavaScript type, see why objects are shared while primitives are copied, and learn exactly how equality and type coercion decide what your comparisons return." },
    { g: 'Learn', t: "Operators (JavaScript fundamentals 5)", p: '/learn/js-operators', e: "Calculate, compare and combine values with JavaScript's operators, give missing values safe defaults with ?? and ?., and avoid the classic precedence traps." },
    ...
    { g: 'Learn', t: "Arrays (JavaScript fundamentals 9)", p: '/learn/js-arrays', e: "Keep ordered lists in arrays, add and remove items, search them, and transform them with map, filter, reduce and sort, then build a small student management system." },
    ...
    { g: 'Learn', t: "Scope and how code runs (JavaScript fundamentals 13)", p: '/learn/js-scope', e: "Learn where a name can be used, how closures remember values, why some names exist before their line runs, and how the call stack and the heap work, so you can read error messages and debug real programs." },
    ...
    { g: 'Learn', t: "this, prototypes and classes (JavaScript fundamentals 16)", p: '/learn/js-classes', e: "Understand what this means inside a method and why it gets lost, how objects share methods through prototypes, and how to write classes with private fields, getters, static methods and inheritance." },
    { g: 'Learn', t: "Handling errors (JavaScript fundamentals 17)", p: '/learn/js-errors', e: "Tell syntax, runtime and logic errors apart, throw and catch errors, read an Error object's name, message, cause and stack, write your own error classes, and turn errors into safe API answers." },
    { g: 'Learn', t: "Asynchronous JavaScript (JavaScript fundamentals 18)", p: '/learn/js-async', e: "Learn why a backend waits without blocking, how callbacks, promises and async/await work, how errors travel through asynchronous code, and how to run work in sequence or in parallel." },
    ...
    { g: 'Learn', t: "The frequency counter pattern (Algorithms and data structures 15)", p: '/learn/pattern-frequency', e: "Replace nested loops with one counting pass: check anagram usernames, reconcile lists, find the first unmatched entry and the majority, in O(n)." },
    { g: 'Learn', t: "The two pointers pattern (Algorithms and data structures 16)", p: '/learn/pattern-two-pointers', e: "Walk sorted data from both ends or at two speeds: pair refunds, dedupe order ids in place, size a tank, and find loops and midpoints with O(1) extra space." },
    { g: 'Learn', t: "Sliding window and prefix sums (Algorithms and data structures 17)", p: '/learn/pattern-sliding-window', e: "Find the best 7 days of revenue, the longest on-time streak and any range total without re-adding numbers, using sliding windows and prefix sums." },
    { g: 'Learn', t: "Binary search on the answer (Algorithms and data structures 18)", p: '/learn/pattern-binary-search', e: "Use binary search beyond sorted arrays: find the smallest truck capacity, the first failing build and items in rotated lists by halving a range of answers." },
    { g: 'Learn', t: "Pattern practice (Algorithms and data structures 19)", p: '/learn/pattern-practice', e: "Solve eleven unlabelled problems by first naming the pattern and why, then coding, testing and analysing, plus two interview walkthroughs." },
    ...
    { g: 'Learn', t: "Iterables and iterators (Advanced JavaScript 8)", p: '/learn/js-iterators', e: "Learn the protocol behind for...of, spread and destructuring, then write your own iterables: a number range and an API paginator that fetches pages lazily." },
    { g: 'Learn', t: "Generators (Advanced JavaScript 9)", p: '/learn/js-generators', e: "Write iterators as ordinary loops with function* and yield, then stream order lines lazily from a paged API into a CSV export, with cleanup that always runs." },
    { g: 'Learn', t: "Symbols (Advanced JavaScript 10)", p: '/learn/js-symbols', e: "Use symbols as keys that never clash, plug your objects into the language with well-known symbols, and build a Money type that refuses to add naira to dollars." },
    { g: 'Learn', t: "Functional JavaScript (Advanced JavaScript 11)", p: '/learn/js-functional', e: "Turn a tangled checkout function into a pipeline of small pure steps, with immutable updates, composition, currying and partial application, and test every step." },
    { g: 'Learn', t: "Promises in depth (Advanced JavaScript 12)", p: '/learn/js-promises', e: "See exactly what a promise guarantees, how chains pass values and errors along, how thenables work, and how to turn a callback SDK into promises safely." },
    { g: 'Learn', t: "Combining promises (Advanced JavaScript 13)", p: '/learn/js-promise-combinators', e: "Run independent work in parallel with Promise.all, allSettled, race and any, put a time limit on a slow provider, and choose sequential, parallel or batched." },
    { g: 'Learn', t: "The event loop (Advanced JavaScript 14)", p: '/learn/js-event-loop', e: "Build an exact model of the call stack, task queue and microtask queue, solve ordering puzzles with it, and keep long jobs from starving timers and requests." },
    { g: 'Learn', t: "Concurrency and cancellation (Advanced JavaScript 15)", p: '/learn/js-concurrency', e: "Limit how many jobs run at once with a pool, cancel unneeded work with AbortController, and find and fix the race conditions of concurrent async code." },
    { g: 'Learn', t: "How JavaScript runs (Advanced JavaScript 16)", p: '/learn/js-execution', e: "Follow your code through the engine, from text to tokens, syntax tree, bytecode and optimized machine code, then read call stacks and async stack traces with confidence." },
    { g: 'Learn', t: "Designing error handling (Advanced JavaScript 17)", p: '/learn/js-error-design', e: "Decide which layer handles each error and which lets it pass, chain causes, collect failures with AggregateError, and build a payment flow that never loses an error." },
    ...
    { g: 'Learn', t: "An HTTP server with no framework (JavaScript in the browser and on the server 7)", p: '/learn/node-http', e: "Build a web server with nothing but Node.js's node:http module. Read the method, path, headers, query and body of each request, send JSON back with the right status code, and route requests by hand." },
    { g: 'Learn', t: "Build a plain Node.js Task API (JavaScript in the browser and on the server 8)", p: '/learn/node-task-api', e: "Finish a complete Task API with no framework, split into modules, with middleware, centralized error handling, API-key protection and configuration from the environment. Then look honestly at what hurts when it grows to 20,000 lines." },
    { g: 'Learn', t: "The DOM (JavaScript in the browser and on the server 9)", p: '/learn/browser-dom', e: "Read and change a web page from JavaScript: find, create, update and remove elements safely, avoid innerHTML XSS, and build a task list UI rendered from data." },
    { g: 'Learn', t: "Events (JavaScript in the browser and on the server 10)", p: '/learn/browser-events', e: "Make pages respond to clicks, typing and forms: listeners, bubbling and capturing, preventDefault, event delegation, custom events and debounced search, in a real shopping cart." },
    { g: 'Learn', t: "The debugging method (JavaScript in the browser and on the server 11)", p: '/learn/debug-method', e: "Find bugs with a repeatable method (observe, reproduce, isolate, hypothesize, test, fix, verify), read stack traces, log well and shrink a bug to a minimal repro." },
    { g: 'Learn', t: "Debugging tools (JavaScript in the browser and on the server 12)", p: '/learn/debug-tools', e: "Pause a running program with breakpoints, step through it, watch values, inspect objects, debug Node.js and browser code, read network traffic and map compiled code back with source maps." },
    { g: 'Learn', t: "Git and GitHub (JavaScript in the browser and on the server 13)", p: '/learn/git', e: "Track every change to your code with Git, work on branches, merge them and resolve a real conflict, keep node_modules and secrets out of your repository, and share your work through GitHub with remotes and pull requests." },
    ...
    { g: 'Learn', t: "Narrowing (TypeScript 10)", p: '/learn/ts-narrowing', e: "Turn wide union and unknown types into precise ones with typeof, truthiness, equality, in, instanceof, discriminants, type guards and assertion functions, and learn where narrowing lies." },
    { g: 'Learn', t: "Type assertions (TypeScript 11)", p: '/learn/ts-assertions', e: "Learn what as, angle-bracket assertions, as unknown as and the non-null ! really do, see why none of them check or convert anything, and replace them with safer tools." },
    { g: 'Learn', t: "Enums and their alternatives (TypeScript 12)", p: '/learn/ts-enums', e: "Write numeric, string and const enums, read the exact JavaScript tsc emits for each, learn the pitfalls and erasableSyntaxOnly, and replace enums with unions and as const objects." },
    { g: 'Learn', t: "Tuples (TypeScript 13)", p: '/learn/ts-tuples', e: "Type fixed-shape arrays with tuples - optional, rest and named elements, readonly tuples, tuple inference and const type parameters - and return tuples from functions the way useState does." },
    { g: 'Learn', t: "Generics (TypeScript 14)", p: '/learn/ts-generics', e: "Write one function, interface or class that works for many types without losing type safety, set rules with constraints and keyof, give type parameters defaults, and build a Result type and a generic repository." },
    { g: 'Learn', t: "Designing generic APIs (TypeScript 15)", p: '/learn/ts-generic-design', e: "Design generic interfaces and classes that stay easy to call - type parameters that earn their place, inference, NoInfer, keyof constraints and defaults - by building Repository, Result, Page, ApiResponse, Cache and typed events." },
    ...
    { g: 'Learn', t: "TypeScript and JavaScript together (TypeScript 19)", p: '/learn/ts-runtime', e: "See exactly what TypeScript becomes when it runs, why types cannot check outside data, and how to close that gap by hand with type guards, assertion functions and a validator that returns a Result." },
    { g: 'Learn', t: "Typed error handling (TypeScript 20)", p: '/learn/ts-errors', e: "Catch errors as unknown, write error classes with a name, a cause and a literal code, return typed results, and handle async failures in a payments service." },
    { g: 'Learn', t: "Async TypeScript (TypeScript 21)", p: '/learn/ts-async', e: "Type promises and async functions precisely, keep Promise.all tuples intact, narrow allSettled results, use Awaited, and page through an API with typed async generators." },
    ...
    { g: 'Learn', t: "Dependency injection with @zudojs/container (ZudoJS fundamentals 9)", p: '/learn/zudo-container', e: "Let a container build and share your services. Learn tokens, class, factory and value providers, the singleton, scoped and transient lifetimes, circular dependency detection, disposal, and swapping real services for fakes in tests." },
    { g: 'Learn', t: "Routes, requests and responses (ZudoJS fundamentals 10)", p: '/learn/zudo-http', e: "Serve the Task API over HTTP with @zudojs/http. Start a server, add routes with parameters, read query strings, headers, cookies and JSON bodies safely, and answer with the right status codes." },
    { g: 'Learn', t: "Middleware, CORS, security headers and graceful shutdown (ZudoJS fundamentals 11)", p: '/learn/zudo-middleware', e: "Wrap every Task API route in middleware. Learn how a middleware pipeline runs, then add security headers, a CORS allow-list, rate limits with @zudojs/security, and a graceful shutdown that lets requests in progress finish." },
    { g: 'Learn', t: "Configuration (ZudoJS fundamentals 12)", p: '/learn/zudo-config', e: "Keep settings out of the code with @zudojs/config. Layer defaults, a config file and environment variables by priority, validate the result with a schema, keep secrets out of logs, and make the Task API's generated configuration stricter in production than in development." },
    { g: 'Learn', t: "Schemas and validation in depth (ZudoJS fundamentals 13)", p: '/learn/zudo-validation', e: "Validate everything that crosses the Task API's boundary with @zudojs/schema. Read issues, coerce query strings, transform and refine values, block unknown fields, validate requests in routes and responses on the way out, and guard against hostile JSON with @zudojs/validation." },
    { g: 'Learn', t: "The ZudoJS error system (ZudoJS fundamentals 14)", p: '/learn/zudo-errors', e: "Handle failures the ZudoJS way. Tell expected errors from bugs, use and extend the error classes in @zudojs/errors, choose codes and categories, serialize errors safely for clients and fully for logs, and turn every error in the Task API into the right HTTP response." },
