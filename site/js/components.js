...
(function () {
  ...
  var SEARCH_INDEX = [
    ...
    { g: 'Learn', t: "3. Set up your computer", p: '/learn/setup', e: "Install Node.js, run your first JavaScript file, and learn the two places you will run code in this course." },
    { g: 'Learn', t: "4. Values, variables and types", p: '/learn/js-values', e: "Store values in variables with const and let, meet the seven primitive types, and learn how JavaScript handles text, numbers, true and false, and \"no value\"." },
    { g: 'Learn', t: "5. Operators", p: '/learn/js-operators', e: "Calculate, compare and combine values with JavaScript's operators, give missing values safe defaults with ?? and ?., and avoid the classic precedence traps." },
    { g: 'Learn', t: "6. Making decisions", p: '/learn/js-conditions', e: "Let your program choose what to do with if, else if and else, the ternary operator and switch, and keep decisions readable with guard clauses." },
    { g: 'Learn', t: "7. Objects and JSON", p: '/learn/js-data', e: "Group related values into objects, read and change their properties, copy and take them apart safely, and turn them into JSON, the text format every API speaks." },
    { g: 'Learn', t: "8. Modern JavaScript", p: '/learn/js-modern', e: "Take a piece of old-style JavaScript and rewrite it step by step with the modern syntax a backend uses every day, fixing real bugs on the way." },
    { g: 'Learn', t: "9. Asynchronous JavaScript", p: '/learn/js-async', e: "Learn why a backend waits without blocking, and how to write code that waits with promises, async and await." },
    { g: 'Learn', t: "10. Modules and errors", p: '/learn/js-modules', e: "Split a program into files with import and export, and handle things that go wrong with throw, try, catch and your own error classes." },
    { g: 'Learn', t: "11. What Node.js is", p: '/learn/node-runtime', e: "Learn what Node.js adds to JavaScript, how its event loop decides what runs next, and how a program talks to the computer through process, exit codes and environment variables." },
    { g: 'Learn', t: "12. Files, paths and your computer", p: '/learn/node-apis', e: "Use Node.js's built-in modules to build safe file paths, read and write files and folders, learn about the computer, make random ids and hashes, and announce events. Then save tasks to a JSON file." },
    { g: 'Learn', t: "13. HTTP in depth", p: '/learn/http-deep', e: "See the exact bytes of an HTTP request and response, then learn the parts every backend developer uses daily: headers, cookies, content types, methods and status codes." },
    { g: 'Learn', t: "14. Why TypeScript exists", p: '/learn/ts-setup', e: "See a bug that JavaScript runs without complaint, install TypeScript, write a tsconfig.json, and learn the three ways to run TypeScript on Node.js 24." },
    { g: 'Learn', t: "15. Describing data with types", p: '/learn/ts-types', e: "Annotate variables and functions, describe a task with type aliases and interfaces, and use optional, readonly and literal types to make wrong data impossible to write." },
    { g: 'Learn', t: "16. Unions, narrowing and generics", p: '/learn/ts-generics', e: "Handle values that can be one of several types, write functions that work for any type with generics, and discover the one thing types cannot do for a backend." },
    { g: 'Learn', t: "17. Your first Zudo code", p: '/learn/zudo-first-code', e: "Install your first ZudoJS packages, check untrusted data at runtime with @zudojs/schema, and report failures with the ready-made errors in @zudojs/errors." },
    { g: 'Learn', t: "18. Create the Task API project", p: '/learn/zudo-create-project', e: "Install the ZudoJS command-line tool, create the Task API project, start its server, and find your way around every file it generated." },
    /* learn-search:end */
