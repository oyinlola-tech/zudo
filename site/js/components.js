...
(function () {
  ...
  var SEARCH_INDEX = [
    ...
    { g: 'Learn', t: "Anatomy of a ZudoJS project (ZudoJS fundamentals 5)", p: '/learn/zudo-project-anatomy', e: "Trace a generated ZudoJS project from src/server.ts through config, runtime and composition root to the controller, service and repository, running its real files." },
    ...
    { g: 'Learn', t: "Middleware, CORS, security headers and graceful shutdown (ZudoJS fundamentals 14)", p: '/learn/zudo-middleware', e: "Wrap every Task API route in middleware: how a pipeline runs, security headers, a CORS allow-list, rate limits, and a shutdown that lets running requests finish." },
    ...
    { g: 'Learn', t: "Use case: background processing (Real-world projects and capstone 5)", p: '/learn/usecase-background-jobs', e: "Move invoice e-mails out of the request: a durable job ledger, a queue with retries and concurrency, scheduled reminders, correlation ids and recovery from crashed workers." },
    ...
    { g: 'Learn', t: "Capstone: ShopFlow (Real-world projects and capstone 8)", p: '/learn/capstone-shopflow', e: "The final project. Plan and build ShopFlow, a small online shop, with ZudoJS. A complete, runnable core for accounts, products and a checkout that never oversells, followed by milestones with acceptance criteria that take it to a modular monolith and then to services." },
