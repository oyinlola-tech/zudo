...
(function () {
  ...
  var SEARCH_INDEX = [
    ...
    { g: 'Learn', t: "Iterables and iterators (Advanced JavaScript 5)", p: '/learn/js-iterators', e: "Learn the protocol behind for...of, spread and destructuring, then write your own iterables: a number range and an API paginator that fetches pages lazily." },
    { g: 'Learn', t: "Generators (Advanced JavaScript 6)", p: '/learn/js-generators', e: "Write iterators as ordinary loops with function* and yield, then stream order lines lazily from a paged API into a CSV export, with cleanup that always runs." },
    { g: 'Learn', t: "Symbols (Advanced JavaScript 7)", p: '/learn/js-symbols', e: "Use symbols as keys that never clash, plug your objects into the language with well-known symbols, and build a Money type that refuses to add naira to dollars." },
    { g: 'Learn', t: "Promises in depth (Advanced JavaScript 8)", p: '/learn/js-promises', e: "See exactly what a promise guarantees, how chains pass values and errors along, how thenables work, and how to turn a callback SDK into promises safely." },
    { g: 'Learn', t: "Combining promises (Advanced JavaScript 9)", p: '/learn/js-promise-combinators', e: "Run independent work in parallel with Promise.all, allSettled, race and any, put a time limit on a slow provider, and choose sequential, parallel or batched." },
    { g: 'Learn', t: "The event loop (Advanced JavaScript 10)", p: '/learn/js-event-loop', e: "Build an exact model of the call stack, task queue and microtask queue, solve ordering puzzles with it, and keep long jobs from starving timers and requests." },
