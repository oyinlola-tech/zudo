...
(function () {
  ...
  var SEARCH_INDEX = [
    ...
    { g: 'Learn', t: "The frequency counter pattern (Algorithms and data structures 13)", p: '/learn/pattern-frequency', e: "Replace nested loops with one counting pass: check anagram usernames, reconcile lists, find the first unmatched entry and the majority, in O(n)." },
    { g: 'Learn', t: "The two pointers pattern (Algorithms and data structures 14)", p: '/learn/pattern-two-pointers', e: "Walk sorted data from both ends or at two speeds: pair refunds, dedupe order ids in place, size a tank, and find loops and midpoints with O(1) extra space." },
    { g: 'Learn', t: "Sliding window and prefix sums (Algorithms and data structures 15)", p: '/learn/pattern-sliding-window', e: "Find the best 7 days of revenue, the longest on-time streak and any range total without re-adding numbers, using sliding windows and prefix sums." },
    ...
    { g: 'Learn', t: "Git and GitHub (JavaScript in the browser and on the server 9)", p: '/learn/git', e: "Track every change to your code with Git, work on branches, merge them and resolve a real conflict, keep node_modules and secrets out of your repository, and share your work through GitHub with remotes and pull requests." },
