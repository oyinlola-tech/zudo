...
(function () {
  ...
  var SEARCH_INDEX = [
    ...
    { g: 'Learn', t: "Linear and binary search (Algorithms and data structures 9)", p: '/learn/dsa-searching', e: "Find an order among a million by scanning and by halving, write binary search three ways, catch its classic bugs, and use lower and upper bounds for ranges." },
