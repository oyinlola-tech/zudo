...
(function () {
  ...
  var SEARCH_INDEX = [
    ...
    { g: 'Learn', t: "Events (JavaScript in the browser and on the server 11)", p: '/learn/browser-events', e: "Make pages respond to clicks, typing and forms: listeners, bubbling and capturing, preventDefault, event delegation, custom events and debounced search, in a real shopping cart." },
    { g: 'Learn', t: "Browser APIs (JavaScript in the browser and on the server 12)", p: '/learn/browser-apis', e: "Use the tools the browser gives JavaScript: fetch, localStorage, URL and URLSearchParams, the History API, timers, requestAnimationFrame and Web Workers, with their failure modes." },
    ...
    { g: 'Learn', t: "Use case: a multi-tenant SaaS (Real-world projects and capstone 2)", p: '/learn/usecase-saas', e: "Build InvoiceHub, where many businesses share one app and one database, and prove with tests that one organization can never read another's data." },
    { g: 'Learn', t: "A whole project through the CLI (Real-world projects and capstone 3)", p: '/learn/zudo-cli-project', e: "Build a hall-booking API from zudojs create to a Docker image, generating each layer with the CLI and fixing the five things the generator gets wrong." },
    { g: 'Learn', t: "Capstone: ShopFlow (Real-world projects and capstone 4)", p: '/learn/capstone-shopflow', e: "The final project. Plan and build ShopFlow, a small online shop, with ZudoJS. A complete, runnable core for accounts, products and a checkout that never oversells, followed by milestones with acceptance criteria that take it to a modular monolith and then to services." },
    { g: 'Learn', t: "Final production challenge (Real-world projects and capstone 5)", p: '/learn/final-challenge', e: "Someone else's gift-card feature works in the demo and fails everything else. Find its architectural problems, then make it production-ready step by step, with acceptance criteria, hints and worked solutions for the key fixes." },
    /* learn-search:end */
