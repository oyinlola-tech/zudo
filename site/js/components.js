...
(function () {
  ...
  var SEARCH_INDEX = [
    ...
    { g: 'Learn', t: "A whole project through the CLI (Real-world projects and capstone 4)", p: '/learn/zudo-cli-project', e: "Build a hall-booking API from zudojs create to a Docker image, generating each layer with the CLI and fixing the five things the generator gets wrong." },
    { g: 'Learn', t: "Capstone: ShopFlow (Real-world projects and capstone 5)", p: '/learn/capstone-shopflow', e: "The final project. Plan and build ShopFlow, a small online shop, with ZudoJS. A complete, runnable core for accounts, products and a checkout that never oversells, followed by milestones with acceptance criteria that take it to a modular monolith and then to services." },
    { g: 'Learn', t: "Final production challenge (Real-world projects and capstone 6)", p: '/learn/final-challenge', e: "Someone else's gift-card feature works in the demo and fails everything else. Find its architectural problems, then make it production-ready step by step, with acceptance criteria, hints and worked solutions for the key fixes." },
    /* learn-search:end */
