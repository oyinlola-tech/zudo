...
(function () {
  ...
  var SEARCH_INDEX = [
    ...
    { g: 'Learn', t: "The frequency counter pattern (Algorithms and data structures 14)", p: '/learn/pattern-frequency', e: "Replace nested loops with one counting pass: check anagram usernames, reconcile lists, find the first unmatched entry and the majority, in O(n)." },
    { g: 'Learn', t: "The two pointers pattern (Algorithms and data structures 15)", p: '/learn/pattern-two-pointers', e: "Walk sorted data from both ends or at two speeds: pair refunds, dedupe order ids in place, size a tank, and find loops and midpoints with O(1) extra space." },
    { g: 'Learn', t: "Sliding window and prefix sums (Algorithms and data structures 16)", p: '/learn/pattern-sliding-window', e: "Find the best 7 days of revenue, the longest on-time streak and any range total without re-adding numbers, using sliding windows and prefix sums." },
    { g: 'Learn', t: "Binary search on the answer (Algorithms and data structures 17)", p: '/learn/pattern-binary-search', e: "Use binary search beyond sorted arrays: find the smallest truck capacity, the first failing build and items in rotated lists by halving a range of answers." },
    ...
    { g: 'Learn', t: "Iterables and iterators (Advanced JavaScript 7)", p: '/learn/js-iterators', e: "Learn the protocol behind for...of, spread and destructuring, then write your own iterables: a number range and an API paginator that fetches pages lazily." },
    { g: 'Learn', t: "Generators (Advanced JavaScript 8)", p: '/learn/js-generators', e: "Write iterators as ordinary loops with function* and yield, then stream order lines lazily from a paged API into a CSV export, with cleanup that always runs." },
    { g: 'Learn', t: "Symbols (Advanced JavaScript 9)", p: '/learn/js-symbols', e: "Use symbols as keys that never clash, plug your objects into the language with well-known symbols, and build a Money type that refuses to add naira to dollars." },
    { g: 'Learn', t: "Functional JavaScript (Advanced JavaScript 10)", p: '/learn/js-functional', e: "Turn a tangled checkout function into a pipeline of small pure steps, with immutable updates, composition, currying and partial application, and test every step." },
    { g: 'Learn', t: "Promises in depth (Advanced JavaScript 11)", p: '/learn/js-promises', e: "See exactly what a promise guarantees, how chains pass values and errors along, how thenables work, and how to turn a callback SDK into promises safely." },
    { g: 'Learn', t: "Combining promises (Advanced JavaScript 12)", p: '/learn/js-promise-combinators', e: "Run independent work in parallel with Promise.all, allSettled, race and any, put a time limit on a slow provider, and choose sequential, parallel or batched." },
    { g: 'Learn', t: "The event loop (Advanced JavaScript 13)", p: '/learn/js-event-loop', e: "Build an exact model of the call stack, task queue and microtask queue, solve ordering puzzles with it, and keep long jobs from starving timers and requests." },
    { g: 'Learn', t: "Concurrency and cancellation (Advanced JavaScript 14)", p: '/learn/js-concurrency', e: "Limit how many jobs run at once with a pool, cancel unneeded work with AbortController, and find and fix the race conditions of concurrent async code." },
    ...
    { g: 'Learn', t: "The debugging method (JavaScript in the browser and on the server 10)", p: '/learn/debug-method', e: "Find bugs with a repeatable method (observe, reproduce, isolate, hypothesize, test, fix, verify), read stack traces, log well and shrink a bug to a minimal repro." },
    { g: 'Learn', t: "Git and GitHub (JavaScript in the browser and on the server 11)", p: '/learn/git', e: "Track every change to your code with Git, work on branches, merge them and resolve a real conflict, keep node_modules and secrets out of your repository, and share your work through GitHub with remotes and pull requests." },
