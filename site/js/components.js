...
(function () {
  ...
  var SEARCH_INDEX = [
    ...
    { g: 'Learn', t: "Operators (JavaScript fundamentals 3)", p: '/learn/js-operators', e: "Calculate, compare and combine values with JavaScript's operators, give missing values safe defaults with ?? and ?., and avoid the classic precedence traps." },
    { g: 'Learn', t: "Making decisions (JavaScript fundamentals 4)", p: '/learn/js-conditions', e: "Let your program choose what to do with if, else if and else, the ternary operator and switch, and keep decisions readable with guard clauses." },
    { g: 'Learn', t: "Loops (JavaScript fundamentals 5)", p: '/learn/js-loops', e: "Repeat work with for, while, do...while, for...of and for...in, control a loop with break and continue, and build a number guessing game." },
    { g: 'Learn', t: "Functions (JavaScript fundamentals 6)", p: '/learn/js-functions', e: "Package logic into reusable functions, pass values in and get results out, pass functions to other functions, and meet scope, closures and recursion." },
    { g: 'Learn', t: "Arrays (JavaScript fundamentals 7)", p: '/learn/js-arrays', e: "Keep ordered lists in arrays, add and remove items, search them, and transform them with map, filter, reduce and sort, then build a small student management system." },
    { g: 'Learn', t: "Objects and JSON (JavaScript fundamentals 8)", p: '/learn/js-data', e: "Group related values into objects, read and change their properties, copy and take them apart safely, and turn them into JSON, the text format every API speaks." },
    { g: 'Learn', t: "Modern JavaScript (JavaScript fundamentals 9)", p: '/learn/js-modern', e: "Take a piece of old-style JavaScript and rewrite it step by step with the modern syntax a backend uses every day, fixing real bugs on the way." },
    { g: 'Learn', t: "Scope and how code runs (JavaScript fundamentals 10)", p: '/learn/js-scope', e: "Learn where a name can be used, how closures remember values, why some names exist before their line runs, and how the call stack and the heap work, so you can read error messages and debug real programs." },
    ...
    { g: 'Learn', t: "Asynchronous JavaScript (JavaScript fundamentals 13)", p: '/learn/js-async', e: "Learn why a backend waits without blocking, how callbacks, promises and async/await work, how errors travel through asynchronous code, and how to run work in sequence or in parallel." },
    { g: 'Learn', t: "Modules (JavaScript fundamentals 14)", p: '/learn/js-modules', e: "Split a program into files with ES modules, understand the older CommonJS require, choose between named and default exports, and avoid circular dependencies." },
    ...
    { g: 'Learn', t: "Advanced and utility types (TypeScript 6)", p: '/learn/ts-advanced', e: "Build new types from existing ones with keyof, typeof, indexed access, mapped, conditional and template literal types, and use the built-in utility types (Partial, Pick, Omit, Record, ReturnType, Awaited and more) to keep one source of truth." },
    { g: 'Learn', t: "Classes in TypeScript (TypeScript 7)", p: '/learn/ts-classes', e: "Declare typed class properties, use parameter properties and access modifiers, compare private with #private, write abstract classes and classes that implement interfaces, and wire classes together with constructor injection." },
    { g: 'Learn', t: "Modules in TypeScript (TypeScript 8)", p: '/learn/ts-modules', e: "Split a TypeScript project into files, import types with import type, see why verbatimModuleSyntax exists, write .js in import paths, and understand how NodeNext resolution, \"type\" - \"module\" and the \"exports\" field fit together." },
    { g: 'Learn', t: "TypeScript and JavaScript together (TypeScript 9)", p: '/learn/ts-runtime', e: "See exactly what TypeScript becomes when it runs, why types cannot check outside data, and how to close that gap by hand with type guards, assertion functions and a validator that returns a Result." },
