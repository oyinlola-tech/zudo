...
(function () {
  ...
  var SEARCH_INDEX = [
    ...
    { g: 'Learn', t: "Welcome to the learning path (Programming thinking 1)", p: '/learn/welcome', e: "What this free course is, who it is for, what you will build, and how the lessons and the terminal on each page work." },
    ...
    { g: 'Learn', t: "Set up your computer (JavaScript fundamentals 1)", p: '/learn/setup', e: "Install Node.js, try JavaScript in the Node.js REPL, write and run your first program, and turn its folder into a project." },
    { g: 'Learn', t: "Values, variables and types (JavaScript fundamentals 2)", p: '/learn/js-values', e: "Store values in variables with const and let, meet the seven primitive types, and learn how JavaScript handles text, numbers, true and false, and \"no value\"." },
    { g: 'Learn', t: "Scope and how code runs (JavaScript fundamentals 3)", p: '/learn/js-scope', e: "Learn where a name can be used, how closures remember values, why some names exist before their line runs, and how the call stack and the heap work, so you can read error messages and debug real programs." },
    ...
    { g: 'Learn', t: "Modern JavaScript (JavaScript fundamentals 10)", p: '/learn/js-modern', e: "Take a piece of old-style JavaScript and rewrite it step by step with the modern syntax a backend uses every day, fixing real bugs on the way." },
    { g: 'Learn', t: "this, prototypes and classes (JavaScript fundamentals 11)", p: '/learn/js-classes', e: "Understand what this means inside a method and why it gets lost, how objects share methods through prototypes, and how to write classes with private fields, getters, static methods and inheritance." },
    { g: 'Learn', t: "Handling errors (JavaScript fundamentals 12)", p: '/learn/js-errors', e: "Tell syntax, runtime and logic errors apart, throw and catch errors, read an Error object's name, message, cause and stack, write your own error classes, and turn errors into safe API answers." },
    { g: 'Learn', t: "Modules (JavaScript fundamentals 13)", p: '/learn/js-modules', e: "Split a program into files with ES modules, understand the older CommonJS require, choose between named and default exports, and avoid circular dependencies." },
    { g: 'Learn', t: "Asynchronous JavaScript (JavaScript fundamentals 14)", p: '/learn/js-async', e: "Learn why a backend waits without blocking, how callbacks, promises and async/await work, how errors travel through asynchronous code, and how to run work in sequence or in parallel." },
    ...
    { g: 'Learn', t: "An HTTP server with no framework (JavaScript in the browser and on the server 4)", p: '/learn/node-http', e: "Build a web server with nothing but Node.js's node:http module. Read the method, path, headers, query and body of each request, send JSON back with the right status code, and route requests by hand." },
    { g: 'Learn', t: "Build a plain Node.js Task API (JavaScript in the browser and on the server 5)", p: '/learn/node-task-api', e: "Finish a complete Task API with no framework, split into modules, with middleware, centralized error handling, API-key protection and configuration from the environment. Then look honestly at what hurts when it grows to 20,000 lines." },
    { g: 'Learn', t: "npm and packages (JavaScript in the browser and on the server 6)", p: '/learn/npm-packages', e: "Install, update and remove packages with npm, read package.json and package-lock.json, understand version ranges, write npm scripts, share code with workspaces, see what publishing would send, and keep the packages you install safe." },
    ...
    { g: 'Learn', t: "Basic types (TypeScript 2)", p: '/learn/ts-types', e: "The everyday types of TypeScript - strings, numbers, booleans, arrays, tuples and object types - plus any vs unknown, null and undefined under strict mode, void, and never for exhaustive checks." },
    { g: 'Learn', t: "Typing functions (TypeScript 3)", p: '/learn/ts-functions', e: "Give functions parameter and return types, use optional, default and rest parameters, describe functions and callbacks as types, type async functions with Promise, and meet overloads." },
    { g: 'Learn', t: "Interfaces, unions and literal types (TypeScript 4)", p: '/learn/ts-objects', e: "Name object shapes with interfaces and type aliases, mark properties optional or readonly, extend and combine shapes, and model data that can take several forms with unions, literal types and discriminated unions." },
    { g: 'Learn', t: "Generics (TypeScript 5)", p: '/learn/ts-generics', e: "Write one function, interface or class that works for many types without losing type safety, set rules with constraints and keyof, give type parameters defaults, and build a Result type and a generic repository." },
    { g: 'Learn', t: "Classes in TypeScript (TypeScript 6)", p: '/learn/ts-classes', e: "Declare typed class properties, use parameter properties and access modifiers, compare private with #private, write abstract classes and classes that implement interfaces, and wire classes together with constructor injection." },
    { g: 'Learn', t: "Modules in TypeScript (TypeScript 7)", p: '/learn/ts-modules', e: "Split a TypeScript project into files, import types with import type, see why verbatimModuleSyntax exists, write .js in import paths, and understand how NodeNext resolution, \"type\" - \"module\" and the \"exports\" field fit together." },
    { g: 'Learn', t: "TypeScript and JavaScript together (TypeScript 8)", p: '/learn/ts-runtime', e: "See exactly what TypeScript becomes when it runs, why types cannot check outside data, and how to close that gap by hand with type guards, assertion functions and a validator that returns a Result." },
    { g: 'Learn', t: "Advanced and utility types (Advanced TypeScript 1)", p: '/learn/ts-advanced', e: "Build new types from existing ones with keyof, typeof, indexed access, mapped, conditional and template literal types, and use the built-in utility types (Partial, Pick, Omit, Record, ReturnType, Awaited and more) to keep one source of truth." },
    ...
    { g: 'Learn', t: "\"BookStore API: HTTP and routing\" (Backend engineering 2)", p: '/learn/bookstore-http', e: "Start a TypeScript backend with no framework at all. Set up the folder, read configuration from the environment, write a small typed router, JSON helpers and error responses, and serve books and authors over HTTP." },
    { g: 'Learn', t: "\"BookStore API: validation and PostgreSQL\" (Backend engineering 3)", p: '/learn/bookstore-data', e: "Check every request body by hand with type guards, move the BookStore data into PostgreSQL with PGlite, write repositories with parameterized SQL, and map typed errors to 400, 404 and 409." },
    { g: 'Learn', t: "\"BookStore API: authentication and tests\" (Backend engineering 4)", p: '/learn/bookstore-auth', e: "Add users to the BookStore. Hash passwords with scrypt, issue signed log-in tokens with a secret from the environment, protect the order routes, test it all with node:test, and then look honestly at what this hand-built backend now gets wrong." },
    { g: 'Learn', t: "Testing fundamentals (Backend engineering 5)", p: '/learn/testing-basics', e: "Why automated tests matter, the difference between unit, integration and end-to-end tests, and how to write them with node:assert and Node's built-in test runner, including mocks, spies, isolated tests and a fresh test database. Then the same tests in Vitest." },
    { g: 'Learn', t: "How databases work (Database engineering 1)", p: '/learn/databases', e: "Why a backend keeps its data in a database, how relational databases organise it into tables and relationships, and what keys, constraints, indexes, transactions and migrations do, with real PostgreSQL running inside Node.js." },
    { g: 'Learn', t: "SQL with PostgreSQL (Database engineering 2)", p: '/learn/sql-basics', e: "Install PostgreSQL with an installer or with Docker, talk to it with psql, and learn the SQL every backend uses: create, insert, select, update and delete, with filters, sorting and paging, and parameterized queries that stop SQL injection." },
    { g: 'Learn', t: "Joins, grouping and transactions (Database engineering 3)", p: '/learn/sql-advanced', e: "Combine tables with joins, summarise data with group by and aggregates, filter groups with having, nest queries, control transactions yourself, measure queries with explain analyze, and connect Node.js to a real PostgreSQL server." },
    { g: 'Learn', t: "Designing a REST API (API engineering 1)", p: '/learn/rest-design', e: "Turn the Task API into a well-designed REST API: resources and URLs, a written contract, filtering, sorting, offset and cursor pagination, versioning and one consistent error format." },
    ...
    { g: 'Learn', t: "Configuration (ZudoJS fundamentals 6)", p: '/learn/zudo-config', e: "Keep settings out of the code with @zudojs/config. Layer defaults, a config file and environment variables by priority, validate the result with a schema, keep secrets out of logs, and make the Task API's generated configuration stricter in production than in development." },
    { g: 'Learn', t: "The ZudoJS error system (ZudoJS fundamentals 7)", p: '/learn/zudo-errors', e: "Handle failures the ZudoJS way. Tell expected errors from bugs, use and extend the error classes in @zudojs/errors, choose codes and categories, serialize errors safely for clients and fully for logs, and turn every error in the Task API into the right HTTP response." },
    { g: 'Learn', t: "Routes, requests and responses (ZudoJS fundamentals 8)", p: '/learn/zudo-http', e: "Serve the Task API over HTTP with @zudojs/http. Start a server, add routes with parameters, read query strings, headers, cookies and JSON bodies safely, and answer with the right status codes." },
    { g: 'Learn', t: "Middleware, CORS, security headers and graceful shutdown (ZudoJS fundamentals 9)", p: '/learn/zudo-middleware', e: "Wrap every Task API route in middleware. Learn how a middleware pipeline runs, then add security headers, a CORS allow-list, rate limits with @zudojs/security, and a graceful shutdown that lets requests in progress finish." },
    { g: 'Learn', t: "Schemas and validation in depth (ZudoJS fundamentals 10)", p: '/learn/zudo-validation', e: "Validate everything that crosses the Task API's boundary with @zudojs/schema. Read issues, coerce query strings, transform and refine values, block unknown fields, validate requests in routes and responses on the way out, and guard against hostile JSON with @zudojs/validation." },
    { g: 'Learn', t: "Security for every public API (ZudoJS application development 1)", p: '/learn/zudo-security', e: "Protect the Task API from the open internet with @zudojs/security and the security helpers in @zudojs/http. Rate limiting, CORS, CSRF, security headers, HSTS and CSP, secure cookies, body limits, SSRF protection and input checks, each shown blocking a real attack." },
    { g: 'Learn', t: "Authentication (ZudoJS application development 2)", p: '/learn/zudo-auth', e: "Let users log in to the Task API. Hash passwords, issue and check JWTs, keep server-side sessions with a real logout, protect routes in @zudojs/http, and stop password guessing with lockouts and rate limits, using @zudojs/auth and @zudojs/crypto." },
    { g: 'Learn', t: "Sign in with OAuth (ZudoJS application development 3)", p: '/learn/zudo-oauth', e: "Add \"Sign in with Google\" to the Task API with @zudojs/auth-oauth. Learn the OAuth 2 authorization code flow, state and PKCE, the provider presets, and the callback, all tested offline against a stand-in provider." },
    { g: 'Learn', t: "Permissions (ZudoJS application development 4)", p: '/learn/zudo-permissions', e: "Decide what each logged-in user may do with @zudojs/permissions. Roles, resource:action permissions, wildcards, role hierarchy, owner rules, deny rules, policies and explain mode, and the mistakes that let a normal user become an admin." },
    { g: 'Learn', t: "Databases with @zudojs/database (ZudoJS application development 5)", p: '/learn/zudo-database', e: "Connect the Task API to PostgreSQL through @zudojs/database, with migrations, seeds, a repository, a query builder, pagination, transactions and health checks, all running against real PostgreSQL." },
    { g: 'Learn', t: "Transactions (ZudoJS application development 6)", p: '/learn/zudo-transactions', e: "Coordinate transactions across many functions with @zudojs/transactions, with context that follows your code through AsyncLocalStorage, rollbacks, savepoints, after-commit hooks, retries, timeouts and rollback-only state, against real PostgreSQL." },
    { g: 'Learn', t: "Storage abstractions (ZudoJS application development 7)", p: '/learn/zudo-storage', e: "Use @zudojs/storage's driver-independent contracts for databases, files, serialization, locks, connection pools and start-up and shutdown, with a PostgreSQL adapter and local file storage for the Task API." },
    ...
    { g: 'Learn', t: "OpenAPI documents (ZudoJS application development 9)", p: '/learn/zudo-openapi', e: "Describe the Task API in an OpenAPI document with @zudojs/openapi. Turn your schemas into components, choose between OpenAPI 3.0 and 3.1, validate the document, save it as JSON or YAML, and serve a documentation page." },
    ...
    { g: 'Learn', t: "Plugins (ZudoJS advanced systems 9)", p: '/learn/zudo-plugins', e: "Let other code extend the Task API without editing it. Write plugins, declare dependencies, run their lifecycle, give each one a scoped context, roll back failed starts, read diagnostics and publish a plugin to npm with @zudojs/plugins." },
    { g: 'Learn', t: "Feature flags (ZudoJS advanced systems 10)", p: '/learn/zudo-feature-flags', e: "Turn features on and off without deploying. Rules, evaluation context, percentage rollouts, A/B variants, kill switches and browser snapshots with @zudojs/feature-flags." },
    { g: 'Learn', t: "Multi-tenancy (ZudoJS advanced systems 11)", p: '/learn/zudo-tenancy', e: "Serve many companies from one Task API without ever mixing their data. Tenant ids, resolvers and trust levels, resolver chains, AsyncLocalStorage context and tenant-scoped queries with @zudojs/tenancy." },
    { g: 'Learn', t: "Testing a ZudoJS app (ZudoJS advanced systems 12)", p: '/learn/zudo-testing', e: "Test the Task API with Vitest and @zudojs/testing. Control time with a test clock, replace services with mocks and recording buses, wire fakes through a test container, clean up in the right order, and run integration tests against a real HTTP server." },
    { g: 'Learn', t: "Structured logging (ZudoJS advanced systems 13)", p: '/learn/zudo-logging', e: "Replace console.log with structured log entries that a program can search. Levels, child loggers, request ids, request and error logging, secret redaction and JSON logs for production with @zudojs/logger." },
    { g: 'Learn', t: "Observability (ZudoJS advanced systems 14)", p: '/learn/zudo-observability', e: "See inside a running Task API. Metrics count what happens, traces show where the time goes, and logs, metrics and traces share one trace id across requests and services, with @zudojs/observability." },
