...
(function () {
  ...
  var SEARCH_INDEX = [
    ...
    { g: 'Learn', t: "How programs run (Programming thinking 3)", p: '/learn/how-programs-run', e: "What happens between the code you type and the result on screen: compilers, interpreters, engines and runtimes, and syntax, runtime and logic errors." },
    ...
    { g: 'Learn', t: "Algorithms (Programming thinking 7)", p: '/learn/think-algorithms', e: "Learn what makes a method an algorithm, the three shapes every algorithm is built from, and everyday searching, counting, filtering and sorting." },
    ...
    { g: 'Learn', t: "Conditional reasoning (Programming thinking 11)", p: '/learn/logic-conditions', e: "Turn business rules into exact conditions, invert and simplify them safely with De Morgan's laws, and write guard clauses that explain every refusal." },
    { g: 'Learn', t: "Sets (Programming thinking 12)", p: '/learn/logic-sets', e: "Reason about groups with sets: remove duplicates, test membership, and combine permissions, tags and mailing lists with union, intersection and difference." },
    { g: 'Learn', t: "Mathematical reasoning (Programming thinking 13)", p: '/learn/logic-math', e: "Use expressions, equations, ratios and percentages to compute discounts, VAT and interest, and keep money exact by counting in kobo, not decimals." },
    { g: 'Learn', t: "Sequences (Programming thinking 14)", p: '/learn/logic-sequences', e: "Spot the pattern in a list of numbers, compute arithmetic and geometric sequences with loops and formulas, and see why compound interest surprises people." },
    { g: 'Learn', t: "Counting (Programming thinking 15)", p: '/learn/logic-counting', e: "Count with loops and frequency tables, count possibilities with permutations and combinations, and see why trying every option soon becomes impossible." },
    ...
    { g: 'Learn', t: "Problem workshop: intermediate (Programming thinking 17)", p: '/learn/solve-intermediate', e: "Solve eight problems on lists of real data, from duplicate payments to stock levels, reasoning about edge cases and work first, then coding and testing." },
    ...
    { g: 'Learn', t: "Divide and conquer (Algorithms and data structures 12)", p: '/learn/dsa-divide-conquer', e: "Split problems into halves and combine: find delivery-time percentiles with quickselect, compute powers fast, and predict cost with recursion trees." },
    { g: 'Learn', t: "Graph search (Algorithms and data structures 13)", p: '/learn/dsa-graph-search', e: "Route parcels with breadth-first search, solve a warehouse maze, find cut-off areas and circular transfers with depth-first search, and meet Dijkstra." },
    { g: 'Learn', t: "Greedy algorithms (Algorithms and data structures 14)", p: '/learn/dsa-greedy', e: "Give change in naira, book meeting rooms and load a van by taking the best-looking choice, then prove when that works and catch it failing with tests." },
    { g: 'Learn', t: "Backtracking (Algorithms and data structures 15)", p: '/learn/dsa-backtracking', e: "Find every valid coupon combination, gift bundle and delivery route by choosing, exploring and undoing, then prune dead branches to solve N-queens and sudoku." },
    { g: 'Learn', t: "Dynamic programming (Algorithms and data structures 16)", p: '/learn/dsa-dynamic-programming', e: "Turn exponential searches into fast tables: pack a delivery van, make change in naira, and diff two versions of a text, with memoization and tabulation." },
    ...
    { g: 'Learn', t: "Inheritance and composition (Advanced JavaScript 3)", p: '/learn/js-composition', e: "See why subclasses break when their parent changes, then build behaviour from wrappers, delegation, mixins and functions, and use private fields well." },
    { g: 'Learn', t: "Strings in depth (Advanced JavaScript 4)", p: '/learn/js-strings', e: "Measure, cut, normalise, search, sort and format product names with accents and emoji, using code points, graphemes, Intl.Segmenter and Intl.Collator." },
    ...
    { g: 'Learn', t: "Collections in depth (Advanced JavaScript 6)", p: '/learn/js-collections', e: "Choose between Map, Set, WeakMap, WeakSet and WeakRef by how they compare keys, keep order and hold memory; build a bounded cache and object-keyed memos." },
    ...
    { g: 'Learn', t: "Regular expressions (Advanced JavaScript 8)", p: '/learn/js-regexp', e: "Validate phone numbers and order codes, parse log lines with named groups, rewrite text with replacers, and avoid regex patterns that freeze a server." },
    ...
    { g: 'Learn', t: "What Node.js is (JavaScript in the browser and on the server 1)", p: '/learn/node-runtime', e: "Learn what Node.js adds to JavaScript, where its event loop fits, and how a program uses arguments, exit codes and environment variables to talk to the system." },
    ...
    { g: 'Learn', t: "Advanced and utility types (TypeScript 16)", p: '/learn/ts-advanced', e: "Derive types from one source of truth with keyof, typeof, indexed access and the utility types, and get a first look at mapped, conditional and template types." },
    { g: 'Learn', t: "Classes in TypeScript (TypeScript 17)", p: '/learn/ts-classes', e: "Type class properties, use access modifiers and #private, write abstract classes and classes that implement interfaces, and inject dependencies." },
    { g: 'Learn', t: "Modules in TypeScript (TypeScript 18)", p: '/learn/ts-modules', e: "Split a project into files, import types with import type, write .js in import paths, and see how NodeNext, \"type\": \"module\" and \"exports\" fit together." },
    ...
    { g: 'Learn', t: "TypeScript and JavaScript together (TypeScript 20)", p: '/learn/ts-runtime', e: "See why types cannot check data that arrives while the program runs, and close the gap by hand with guards, assertion functions and a validator." },
    { g: 'Learn', t: "Runtime validation (TypeScript 21)", p: '/learn/ts-validation', e: "See why an annotation on parsed JSON checks nothing, then validate data at runtime with a schema you build, Zod, Valibot and JSON Schema, and infer types." },
    ...
    { g: 'Learn', t: "Async TypeScript (TypeScript 23)", p: '/learn/ts-async', e: "Type async functions precisely, keep Promise.all tuples intact, narrow allSettled results, use Awaited, and page through an API with async generators." },
    ...
    { g: 'Learn', t: "Utility types (Advanced TypeScript 2)", p: '/learn/ts-utility-types', e: "Use and rebuild TypeScript's utility types, from Partial, Pick and Omit to Exclude, ReturnType, Awaited and ThisType, and learn where each one bites." },
    { g: 'Learn', t: "Mapped types (Advanced TypeScript 3)", p: '/learn/ts-mapped-types', e: "Loop over keys at the type level: change modifiers, remap keys with as, filter and recurse into nested objects, then build a type-safe config system." },
    ...
    { g: 'Learn', t: "Advanced inference (Advanced TypeScript 6)", p: '/learn/ts-inference-deep', e: "Learn how TypeScript infers type arguments, contextual types and return types, use const type parameters, and choose satisfies, as or as const." },
    { g: 'Learn', t: "Advanced functions (Advanced TypeScript 7)", p: '/learn/ts-advanced-functions', e: "Type overloads, call and construct signatures, this parameters, callable objects and variadic tuples, then build a type-safe command router." },
    { g: 'Learn', t: "Object-oriented TypeScript (Advanced TypeScript 8)", p: '/learn/ts-oop', e: "Use encapsulation, abstraction, inheritance, polymorphism, composition and dependency inversion, then compare OOP and functional designs honestly." },
    ...
    { g: 'Learn', t: "Decorators (Advanced TypeScript 16)", p: '/learn/ts-decorators', e: "Write TC39 standard decorators for classes, methods, fields and accessors, see the JavaScript tsc emits, and compare them with experimentalDecorators." },
    { g: 'Learn', t: "Declaration files (Advanced TypeScript 17)", p: '/learn/ts-declarations', e: "Type an untyped JavaScript naira formatter with a .d.ts file, declare modules and globals, augment interfaces, install @types and generate declarations." },
    { g: 'Learn', t: "Publishing TypeScript packages (Advanced TypeScript 18)", p: '/learn/ts-publishing', e: "Build a TypeScript library into JavaScript plus declarations, write package.json exports, check the tarball, handle ESM and CommonJS, and version types." },
    { g: 'Learn', t: "TypeScript monorepos (Advanced TypeScript 19)", p: '/learn/ts-monorepos', e: "Split a shop backend into core, logger, database, auth and http packages, link with workspaces, build with project references, enforce dependency direction." },
    { g: 'Learn', t: "Testing TypeScript (Advanced TypeScript 20)", p: '/learn/ts-testing', e: "Test TypeScript code with Vitest, including generics, error paths and typed mocks, then test types themselves with expectTypeOf and vitest --typecheck." },
    { g: 'Learn', t: "Debugging TypeScript (Advanced TypeScript 21)", p: '/learn/ts-debugging', e: "Read long type errors from the bottom up, make the compiler show inferred types, fix generic inference and module resolution, and tell type from runtime bugs." },
    { g: 'Learn', t: "Compiler performance (Advanced TypeScript 22)", p: '/learn/ts-performance', e: "Measure what tsc spends its work on with --extendedDiagnostics, then keep a large project fast with skipLibCheck, incremental builds and bounded types." },
    ...
    { g: 'Learn', t: "Designing a REST API (Backend engineering 2)", p: '/learn/rest-design', e: "Design the Task API as a REST API: resource URLs, a written contract, filtering and sorting, offset and cursor pages, versions and one error format." },
    { g: 'Learn', t: "How databases work (Backend engineering 3)", p: '/learn/databases', e: "Why a backend needs a database, and how tables, keys, relationships, constraints, indexes, transactions and migrations work, on real PostgreSQL in Node.js." },
    { g: 'Learn', t: "SQL with PostgreSQL (Backend engineering 4)", p: '/learn/sql-basics', e: "Run PostgreSQL with an installer or Docker, use psql, and write everyday SQL: insert, select, update, delete, and placeholders that stop SQL injection." },
    { g: 'Learn', t: "Joins, grouping and transactions (Backend engineering 5)", p: '/learn/sql-advanced', e: "Join tables, summarise them with group by and having, nest queries, run transactions by hand, measure with explain analyze, and connect Node.js to PostgreSQL." },
    { g: 'Learn', t: "Testing fundamentals (Backend engineering 6)", p: '/learn/testing-basics', e: "Test a backend with Node's built-in runner: unit, integration and end-to-end tests, assertions, mocks and spies, isolated tests and a fresh test database." },
    ...
    { g: 'Learn', t: "\"BookStore API: HTTP and routing\" (Backend engineering 8)", p: '/learn/bookstore-http', e: "Start a TypeScript backend with no framework: a project folder, checked configuration, a typed router, JSON helpers and error responses for books and authors." },
    { g: 'Learn', t: "\"BookStore API: validation and PostgreSQL\" (Backend engineering 9)", p: '/learn/bookstore-data', e: "Check BookStore request bodies with type guards, move the data into PostgreSQL, write repositories with parameterized SQL, and map errors to 400, 404 and 409." },
    { g: 'Learn', t: "\"BookStore API: authentication and tests\" (Backend engineering 10)", p: '/learn/bookstore-auth', e: "Add users to the BookStore: scrypt password hashes, signed log-in tokens, protected order routes and node:test tests, then an honest review of what still hurts." },
    ...
    { g: 'Learn', t: "Typing database code (Database engineering 5)", p: '/learn/db-typescript', e: "Give database rows honest TypeScript types: nullable columns, entities vs DTOs, typed repositories, generated types, and query builder or ORM trade-offs." },
    ...
    { g: 'Learn', t: "Writing injection-safe code (Security 4)", p: '/learn/sec-injection', e: "Keep untrusted data from becoming code: safe SQL, shell args, confined paths, SSRF-safe URLs, unambiguous HTTP, safe merges, linear-time regex." },
    ...
    { g: 'Learn', t: "Types are not security (Security 6)", p: '/learn/ts-security', e: "See why a type cannot decide who may do what: a refund endpoint with runtime validation, server-side authorization, branded ids and unloggable secrets." },
    ...
    { g: 'Learn', t: "Backend architecture (Software design and architecture 6)", p: '/learn/backend-architecture', e: "Apply separation of concerns and SOLID to a whole backend: domain, application and infrastructure layers, ports, dependency injection and a composition root." },
    ...
    { g: 'Learn', t: "What a framework does (Software design and architecture 9)", p: '/learn/frameworks', e: "Library vs framework and inversion of control, then every job a backend framework takes over: lifecycle, DI, routing, config, validation. Build a tiny one." },
    ...
    { g: 'Learn', t: "Reading framework source (Software design and architecture 12)", p: '/learn/framework-read-source', e: "Answer questions the docs cannot by reading published ZudoJS packages: package boundaries, .d.ts files, generics, and a request traced through dist code." },
    { g: 'Learn', t: "Welcome to ZudoJS (ZudoJS fundamentals 1)", p: '/learn/zudo-welcome', e: "Meet ZudoJS: its 38 packages and how they are layered, the zudojs CLI and three application shapes. Then run three of its packages together in your browser." },
    ...
    { g: 'Learn', t: "Create the Task API project (ZudoJS fundamentals 3)", p: '/learn/zudo-create-project', e: "Install the zudojs CLI, create the Task API project, run it in development, find your way around its files, try each command, and build it for production." },
    { g: 'Learn', t: "The ZudoJS CLI in depth (ZudoJS fundamentals 4)", p: '/learn/zudo-cli', e: "Use every command and option of the zudojs CLI, see how it finds your project and names and wires generated files, and read its errors in time." },
    { g: 'Learn', t: "Anatomy of a ZudoJS project (ZudoJS fundamentals 5)", p: '/learn/zudo-project-anatomy', e: "Trace a generated ZudoJS project from src/server.ts through config, runtime and composition root to controller, service and repository, with its real files." },
    ...
    { g: 'Learn', t: "The application runtime and lifecycle (ZudoJS fundamentals 7)", p: '/learn/zudo-runtime', e: "See how @zudojs/runtime starts your app's modules in dependency order, rolls back a failed start, reports readiness honestly and shuts down gracefully." },
    { g: 'Learn', t: "Components with @zudojs/lifecycle (ZudoJS fundamentals 8)", p: '/learn/zudo-lifecycle', e: "Start and stop a database, a job queue and an HTTP server in order with @zudojs/lifecycle: retries, timeouts, priorities, optional parts, rollback, shutdown." },
    ...
    { g: 'Learn', t: "Dependency injection with @zudojs/container (ZudoJS fundamentals 10)", p: '/learn/zudo-container', e: "Let a container build and share your services: tokens, class, factory and value providers, lifetimes, cycle detection, disposal and swapping in test fakes." },
    { g: 'Learn', t: "DI architecture with ZudoJS (ZudoJS fundamentals 11)", p: '/learn/zudo-di-architecture', e: "Decide where every object in a ZudoJS app is built: one composition root, constructor or factory injection, fakes in tests and frozen wiring in production." },
    { g: 'Learn', t: "Routes, requests and responses (ZudoJS fundamentals 12)", p: '/learn/zudo-http', e: "Serve the Task API with @zudojs/http: a server, routes with parameters, query strings, headers, cookies and JSON bodies read safely, and the right status codes." },
    { g: 'Learn', t: "Routing in depth (ZudoJS fundamentals 13)", p: '/learn/zudo-routing', e: "Control which handler answers a request in @zudojs/http: path patterns, matching order, route middleware, groups, repeated query keys and canonical targets." },
    { g: 'Learn', t: "Middleware, CORS, security headers and graceful shutdown (ZudoJS fundamentals 14)", p: '/learn/zudo-middleware', e: "Wrap every Task API route in middleware: how a pipeline runs, security headers, a CORS allow-list, rate limits, and a shutdown that lets requests finish." },
    { g: 'Learn', t: "Middleware pipelines with @zudojs/middleware (ZudoJS fundamentals 15)", p: '/learn/zudo-middleware-pipelines', e: "Build one pipeline for HTTP, CLI and jobs with @zudojs/middleware: logging, auth checks, validation, rate limits, timeouts, error modes and execution tracking." },
    { g: 'Learn', t: "Configuration (ZudoJS fundamentals 16)", p: '/learn/zudo-config', e: "Keep settings out of code with @zudojs/config: layered sources, validation at startup, secrets kept out of logs, and a Task API stricter in production." },
    { g: 'Learn', t: "Schemas and validation in depth (ZudoJS fundamentals 17)", p: '/learn/zudo-validation', e: "Validate everything crossing the Task API's boundary with @zudojs/schema: issues, coercion, transforms, refinements, unknown fields, responses and hostile JSON." },
    { g: 'Learn', t: "Validation rules with @zudojs/validation (ZudoJS fundamentals 18)", p: '/learn/zudo-validation-rules', e: "Go beyond data shapes with @zudojs/validation: constraints, normalizers, composers, Zod, guards and errors, and treat request and response failures differently." },
    { g: 'Learn', t: "The ZudoJS error system (ZudoJS fundamentals 19)", p: '/learn/zudo-errors', e: "Handle failures the ZudoJS way: expected errors versus bugs, your own error classes, safe bodies for clients, full logs, and one handler for the Task API." },
    { g: 'Learn', t: "Databases with @zudojs/database (ZudoJS application development 1)", p: '/learn/zudo-database', e: "Connect the Task API to real PostgreSQL with @zudojs/database: migrations, seeds, a repository, a query builder, pagination, transactions and health checks." },
    ...
    { g: 'Learn', t: "Storage abstractions (ZudoJS application development 3)", p: '/learn/zudo-storage', e: "Use @zudojs/storage's driver-independent contracts for files, serialization, locks and pools, with local file storage and a health report for the Task API." },
    { g: 'Learn', t: "Transactions (ZudoJS application development 4)", p: '/learn/zudo-transactions', e: "Coordinate transactions across functions with @zudojs/transactions: propagation via AsyncLocalStorage, savepoints, after-commit hooks, retries and timeouts." },
    { g: 'Learn', t: "\"Project: a file upload system\" (ZudoJS application development 5)", p: '/learn/zudo-file-uploads', e: "Build task attachments with @zudojs/http and @zudojs/storage: size limits, sniffed content types, safe keys, metadata, fenced locks and failure recovery." },
    { g: 'Learn', t: "Cryptography with @zudojs/crypto (ZudoJS application development 6)", p: '/learn/zudo-crypto', e: "Use @zudojs/crypto for random ids, tokens, hashes, HMAC, password hashing, AES-GCM encryption with key ids and constant-time checks, building reset tokens." },
    { g: 'Learn', t: "Authentication (ZudoJS application development 7)", p: '/learn/zudo-auth', e: "Let users log in to the Task API: hash passwords, issue JWTs, keep sessions with real logout, protect routes, and stop guessing with lockouts and limits." },
    { g: 'Learn', t: "Sign in with OAuth (ZudoJS application development 8)", p: '/learn/zudo-oauth', e: "Add Sign in with Google to the Task API with @zudojs/auth-oauth: the OAuth 2 code flow, state and PKCE, provider presets, tested offline." },
    { g: 'Learn', t: "Permissions (ZudoJS application development 9)", p: '/learn/zudo-permissions', e: "Decide what each logged-in user may do with @zudojs/permissions: roles, wildcards, hierarchy, owner and deny rules, policies, and stopping privilege escalation." },
    { g: 'Learn', t: "Security for every public API (ZudoJS application development 10)", p: '/learn/zudo-security', e: "Protect the Task API from the open internet with @zudojs/security: rate limiting, CORS, CSRF, security headers, secure cookies, body limits, SSRF checks." },
    { g: 'Learn', t: "Caching (ZudoJS application development 11)", p: '/learn/zudo-cache', e: "Keep copies of slow results so the Task API answers fast: keys, TTL, namespaces, tags, invalidation, stampede protection, locks and metrics." },
    { g: 'Learn', t: "Type-safe application design (ZudoJS application development 12)", p: '/learn/zudo-typed-design', e: "Design a billing module for the Task API where ids, money, states, DTOs, commands, queries, events, errors, config and DI are all checked by TypeScript." },
    { g: 'Learn', t: "Events (ZudoJS advanced systems 1)", p: '/learn/zudo-events', e: "Decouple Task API features with events: handlers, wildcards, priorities, sequential and parallel dispatch, middleware and handler errors with @zudojs/events." },
    { g: 'Learn', t: "Messaging (ZudoJS advanced systems 2)", p: '/learn/zudo-messaging', e: "Ask another part of the Task API to do something and get an answer back with @zudojs/messaging: messages, middleware, correlation ids, timeouts, cancellation." },
    { g: 'Learn', t: "Commands and queries (CQRS) (ZudoJS advanced systems 3)", p: '/learn/zudo-cqrs', e: "Split the Task API into commands that change data and queries that only read it: buses, handlers, middleware, execution context, results with @zudojs/cqrs." },
    { g: 'Learn', t: "Background jobs (ZudoJS advanced systems 4)", p: '/learn/zudo-queue', e: "Move slow, unreliable work out of the request into a job queue: jobs, processors, workers, concurrency, retries with backoff, dead letters with @zudojs/queue." },
    { g: 'Learn', t: "Scheduled tasks (ZudoJS advanced systems 5)", p: '/learn/zudo-scheduler', e: "Run work on the clock, not a request: intervals, cron expressions, time zones, retries, overlapping runs and running on one instance with @zudojs/scheduler." },
    { g: 'Learn', t: "Serialization (ZudoJS advanced systems 6)", p: '/learn/zudo-serialization', e: "Turn values into text and back without losing what they were: Dates, BigInts, Maps, Sets, bytes, custom types and versioned payloads with @zudojs/serialization." },
    { g: 'Learn', t: "Calling services with RPC (ZudoJS advanced systems 7)", p: '/learn/zudo-rpc', e: "Call a function in another service as if it were local: procedures, clients, transports, validation, errors, identity, timeouts and retries with @zudojs/rpc." },
    { g: 'Learn', t: "One operation, many transports (ZudoJS advanced systems 8)", p: '/learn/zudo-api', e: "Write business logic once as an operation with @zudojs/api, then run it from HTTP, RPC and a queue with the same validation, errors and timeouts." },
    { g: 'Learn', t: "OpenAPI documents (ZudoJS advanced systems 9)", p: '/learn/zudo-openapi', e: "Describe the Task API in an OpenAPI document with @zudojs/openapi: schemas as components, OpenAPI 3.0 or 3.1, validation, JSON or YAML, a docs page." },
    { g: 'Learn', t: "Testing a ZudoJS app (ZudoJS advanced systems 10)", p: '/learn/zudo-testing', e: "Test the Task API with Vitest and @zudojs/testing: a test clock, mocks and recording buses, a test container, ordered cleanup, and real HTTP integration tests." },
    ...
    { g: 'Learn', t: "Structured logging (ZudoJS advanced systems 12)", p: '/learn/zudo-logging', e: "Replace console.log with structured entries a program can search: levels, child loggers, request ids, redaction and JSON logs with @zudojs/logger." },
    { g: 'Learn', t: "Observability (ZudoJS advanced systems 13)", p: '/learn/zudo-observability', e: "See inside a running Task API: metrics count what happens, traces show where time goes, and logs share one trace id with @zudojs/observability." },
    ...
    { g: 'Learn', t: "Feature flags (ZudoJS advanced systems 15)", p: '/learn/zudo-feature-flags', e: "Turn features on and off without deploying: rules, evaluation context, percentage rollouts, A/B variants and kill switches with @zudojs/feature-flags." },
    { g: 'Learn', t: "Multi-tenancy (ZudoJS advanced systems 16)", p: '/learn/zudo-tenancy', e: "Serve many companies from one Task API without mixing their data: tenant ids, resolvers, trust levels and tenant-scoped queries with @zudojs/tenancy." },
    { g: 'Learn', t: "Plugins (ZudoJS advanced systems 17)", p: '/learn/zudo-plugins', e: "Extend the Task API through a fixed interface without editing it: plugin lifecycle, dependencies, scoped context, rollback and diagnostics with @zudojs/plugins." },
    ...
    { g: 'Learn', t: "From monolith to modular monolith (ZudoJS architecture 2)", p: '/learn/zudo-modular-monolith', e: "Split a growing monolith into modules with clear boundaries: each owns its data, exposes a small public API, and talks to others via events and commands." },
    { g: 'Learn', t: "Microservices (ZudoJS architecture 3)", p: '/learn/zudo-microservices', e: "Why teams split into microservices, why not to start there, and how services discover, call each other, stay consistent, survive failures and stay observable." },
    ...
    { g: 'Learn', t: "Contracts between services (Distributed systems 2)", p: '/learn/dist-contracts', e: "Version service contracts so independent deploys stay compatible: evolve schemas safely and catch breaks with consumer-driven contract tests." },
    { g: 'Learn', t: "Failure engineering (Distributed systems 3)", p: '/learn/dist-reliability', e: "Break ShopFlow with a seeded fault injector, then keep it serving with timeouts, jittered retries, a circuit breaker, bulkheads, fallbacks and readiness checks." },
    { g: 'Learn', t: "Transactions across services (Distributed systems 4)", p: '/learn/dist-transactions', e: "Keep an order, payment, stock and shipment consistent across services with sagas, compensations, a transactional outbox and idempotent consumers." },
    { g: 'Learn', t: "Production engineering (Production engineering 1)", p: '/learn/production-engineering', e: "A checklist for taking a ZudoJS app to production: config, secrets, logs, metrics, health checks, shutdown, rate limits, caching and database performance." },
    ...
    { g: 'Learn', t: "Deploying a ZudoJS app (Production engineering 4)", p: '/learn/deployment', e: "Take the Task API to a server: build it, run with systemd or Docker Compose, add Postgres, Redis and Caddy for HTTPS, migrate safely, back up the database." },
    { g: 'Learn', t: "CI/CD with GitHub Actions (Production engineering 5)", p: '/learn/zudo-ci-cd', e: "Build a pipeline for the Task API that type-checks, lints, tests, audits, builds and deploys every change, with migrations and automatic rollback." },
    { g: 'Learn', t: "Reading ZudoJS internals (Framework engineering 1)", p: '/learn/zudo-internals', e: "Open the published @zudojs packages in node_modules, map their dependency graph, and trace how routing, scopes, wildcards and caching really work." },
    { g: 'Learn', t: "Creating a ZudoJS package (Framework engineering 2)", p: '/learn/zudo-create-package', e: "Build @mycompany/zudo-payments as a real npm package: public/internal API, ZudoJS errors, a provider adapter, Vitest tests, checked docs and changesets." },
    { g: 'Learn', t: "Building a complete ZudoJS plugin (Framework engineering 3)", p: '/learn/zudo-create-plugin', e: "Build a production-grade receipts plugin with @zudojs/plugins: metadata, dependencies, lifecycle, scoped context, events, diagnostics and rollback." },
    ...
    { g: 'Learn', t: "Use case: a payment system (Real-world projects and capstone 3)", p: '/learn/usecase-payments', e: "Build Oja Market's card payments: idempotent requests, a gateway adapter with timeouts and retries, an outbox, events, a notification queue, and failure tests." },
