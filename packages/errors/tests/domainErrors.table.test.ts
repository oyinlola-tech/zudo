...
const rows: readonly Row[] = [
  ...
  { name: "AuthError", make: () => new D.AuthError("m", { cause }), code: ErrorCode.AUTHENTICATION, status: 401, expose: true, hasCause: true },
  { name: "OAuthError", make: () => new D.OAuthError("m", { cause }), code: ErrorCode.OAUTH_PROVIDER_REJECTED, status: 400, expose: true, hasCause: true },
  // ---- round 10: classes moved in from consuming packages ----
  { name: "InvalidConstantError", make: () => new D.InvalidConstantError("m"), code: ErrorCode.CONFIGURATION_INVALID, status: 500, expose: false },
  { name: "ConstantContextError", make: () => new D.ConstantContextError("m"), code: ErrorCode.INVALID_INPUT, status: 500, expose: false },
  { name: "CqrsError", make: () => new D.CqrsError("m", { cause }), code: ErrorCode.INTERNAL_ERROR, status: 500, expose: false, hasCause: true },
  { name: "CommandFailedError", make: () => new D.CommandFailedError("c", cause), code: ErrorCode.COMMAND_FAILED, status: 500, expose: false, own: { commandType: "c" }, hasCause: true },
  { name: "QueryFailedError", make: () => new D.QueryFailedError("q", cause), code: ErrorCode.QUERY_FAILED, status: 500, expose: false, own: { queryType: "q" }, hasCause: true },
  { name: "OpenAPIError", make: () => new D.OpenAPIError("m", { cause }), code: ErrorCode.OPENAPI_DOCUMENT, status: 500, expose: false, hasCause: true },
  { name: "TraversalLimitError", make: () => new D.TraversalLimitError("depth", "$.a", 3), code: ErrorCode.VALIDATION_FAILED, status: 400, expose: false, own: { halt: "depth", path: "$.a", observed: 3 } },
  { name: "TransactionError", make: () => new D.TransactionError("m", { cause }), code: ErrorCode.OPERATION_FAILED, status: 500, expose: false, hasCause: true },
  { name: "TransactionStateError", make: () => new D.TransactionStateError("s", "commit"), code: ErrorCode.LIFECYCLE_STATE, status: 500, expose: false },
  { name: "TransactionTimeoutError", make: () => new D.TransactionTimeoutError("t", 5), code: ErrorCode.TIMEOUT, status: 500, expose: false },
  { name: "TransactionCommitError", make: () => new D.TransactionCommitError("t", cause), code: ErrorCode.DATABASE_TRANSACTION, status: 500, expose: false, hasCause: true },
  { name: "TransactionRollbackError", make: () => new D.TransactionRollbackError("t", { cause }), code: ErrorCode.DATABASE_TRANSACTION, status: 500, expose: false, hasCause: true },
  { name: "TransactionRollbackOnlyError", make: () => new D.TransactionRollbackOnlyError("t", "why"), code: ErrorCode.DATABASE_TRANSACTION, status: 500, expose: false },
  { name: "TransactionAdapterError", make: () => new D.TransactionAdapterError("m", cause), code: ErrorCode.ADAPTER_OPERATION_FAILED, status: 500, expose: false, hasCause: true },
  { name: "TransactionPropagationError", make: () => new D.TransactionPropagationError("m"), code: ErrorCode.VALIDATION_FAILED, status: 500, expose: false },
  { name: "TransactionIsolationError", make: () => new D.TransactionIsolationError("x"), code: ErrorCode.VALIDATION_FAILED, status: 500, expose: false },
  { name: "SavepointError", make: () => new D.SavepointError("m", cause), code: ErrorCode.OPERATION_FAILED, status: 500, expose: false, hasCause: true },
  ...
  { name: "EventBusStoppedError", make: () => new D.EventBusStoppedError("publish"), code: ErrorCode.LIFECYCLE_STATE, status: 500, expose: false, own: { operation: "publish" } },
  ...
  { name: "MessageDispatchAbortedError", make: () => new D.MessageDispatchAbortedError(undefined, { messageType: "t", cause }), code: ErrorCode.MESSAGE_ABORTED, status: 499, expose: false, own: { messageType: "t" }, hasCause: true },
  ...
  { name: "SerializationPayloadTooLargeError", make: () => new D.SerializationPayloadTooLargeError(10, 5), code: ErrorCode.PAYLOAD_TOO_LARGE, status: 413, expose: true, own: { size: 10, maxSize: 5 } },
